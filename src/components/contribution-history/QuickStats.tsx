    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <p className="text-sm text-green-700 dark:text-green-300 font-medium text-left">Total Saved</p>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <p className="text-sm text-blue-700 dark:text-blue-300 font-medium text-left">Monthly Contributions</p>
        </div>
      ...
      <div className={cn("p-4 rounded-lg border", progressColors.background, progressColors.border)}>
        <div className="flex items-center space-x-2 mb-2">
          <TrendingUp className={cn("h-4 w-4", progressColors.text)} />
          <p className={cn("text-sm font-medium text-left", progressColors.text)}>
            Overall Progress
          </p>
        </div>
        <p className={cn("text-2xl font-bold text-left", progressColors.value)}>
          {Math.round(overallProgressPercentage)}%
        </p>
        <p className={cn("text-xs text-left", progressColors.detail)}>
